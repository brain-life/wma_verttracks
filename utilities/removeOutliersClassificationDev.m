function classification= removeOutliersClassificationDev(classification,wbFG, centroidSD, lengthSD, selectPrune)
%
...
for itracts=selectPrune
    ...
    [~, keep]=mbaComputeFibersOutliers(tractFG,centroidSD,lengthSD,5);
